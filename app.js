...
async function connectWallet() {
    if (typeof window.ethereum !== 'undefined') {
        ...
        document.getElementById('walletBalance').innerText = `Balance: ${await provider.getBalance(walletAddress)} ETH`;
...
async function mintNFT() {
    ...
    if (ethers.utils.parseEther(totalPrice.toString()).gt(await provider.getBalance(walletAddress))) {
